...
export const metadata: Metadata = {
    ...
    description: 'Privacy Policy explaining how we collect, use, and protect your data at Media City Dubai.',
    alternates: {
        canonical: '/privacy',
    },
    openGraph: {
        title: 'Privacy Policy | Media City Dubai',
        description: 'Transparency and data protection are central to our community values.',
        url: 'https://mediacitydubai.com/privacy',
    ...
    twitter: {
        ...
        title: 'Privacy Policy | Media City Dubai',
        description: 'How we handle your personal information at Media City Dubai.',
