        ...
        <div className="lunar-bg min-h-screen relative overflow-hidden font-sans pb-24 pt-16">
            ...
            <div className="container mx-auto px-4 relative z-10 max-w-7xl">
                ...
                <div className="text-center mb-16 max-w-2xl mx-auto">
                    <div className="inline-flex items-center justify-center space-x-2 bg-red-500/10 border border-red-500/20 px-3.5 py-1 rounded-full mb-4">
                ...
                {initialKpis.length === 0 && (
                    <div className="lunar-text-slate text-center py-16 lunar-card mt-8">
                        ...
                        <p className="text-sm mt-2 opacity-50">Check back later for new updates.</p>
                    </div>
                )}
            </div>
        </div>
